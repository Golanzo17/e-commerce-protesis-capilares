...
<nav class="sticky top-0 z-50 bg-surface-container-lowest border-b border-outline-variant shadow-sm transition-all duration-300 ease-in-out">
    <div class="flex justify-between items-center px-margin-mobile md:px-margin-desktop py-4 max-w-container-max mx-auto">
        ...
        <div class="flex items-center gap-4">
            ...
            <button class="bg-secondary text-on-secondary px-6 py-2 rounded-full font-label-md text-label-md hover:opacity-90 transition-opacity">WhatsApp</button>
        </div>
    </div>
</nav>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-12 mb-20">
        ...
        <div class="flex flex-col gap-4">
            <div class="aspect-square bg-surface-container-low rounded-xl overflow-hidden border border-outline-variant group">
                <img id="main-product-image" class="w-full h-full object-cover transition-transform duration-700 group-hover:scale-105" data-alt="A high-end medical-grade capillary hair system displayed on a minimalist white ceramic mannequin head. The lighting is soft and professional, highlighting the natural texture and realistic scalp appearance of the hairpiece. The background is a clean, clinic-style setting with soft blue and navy tones, emphasizing a professional and hygienic environment." src="https://lh3.googleusercontent.com/aida-public/AB6AXuB7Ghv7bELk8wGb3beJ60EZFdod9sKId9rwE_t_W7RZSCnuFqb_KQj7122aamUhSK8WOD7yv6eA0FaLscl8xfBiJhUJq_7_vaYd58m4KSzlZhTcYbhpruqaJHoJuD-xIotBObmzQymM7JoxJuRv3_FdTcmfIpiMgUc4AdYSgQ7PlULDeP_be5sH5clihmr0N19Smy5aCkld-g9R-mNvRyhR6onJvU5QMhM8Z0QgkuOI8pEfNGpE7Q_40Q"/>
            </div>
            <div class="grid grid-cols-4 gap-4">
                <button class="aspect-square rounded-lg overflow-hidden border-2 border-secondary p-1 bg-surface-container-lowest transition-colors">
                    <img class="w-full h-full object-cover rounded" data-alt="A high-end medical-grade capillary hair system displayed on a minimalist white ceramic mannequin head. The lighting is soft and professional, highlighting the natural texture and realistic scalp appearance of the hairpiece." src="https://lh3.googleusercontent.com/aida-public/AB6AXuB7Ghv7bELk8wGb3beJ60EZFdod9sKId9rwE_t_W7RZSCnuFqb_KQj7122aamUhSK8WOD7yv6eA0FaLscl8xfBiJhUJq_7_vaYd58m4KSzlZhTcYbhpruqaJHoJuD-xIotBObmzQymM7JoxJuRv3_FdTcmfIpiMgUc4AdYSgQ7PlULDeP_be5sH5clihmr0N19Smy5aCkld-g9R-mNvRyhR6onJvU5QMhM8Z0QgkuOI8pEfNGpE7Q_40Q"/>
                </button>
                <button class="aspect-square rounded-lg overflow-hidden border border-outline-variant p-1 bg-surface-container-lowest hover:border-secondary transition-colors">
                    <img class="w-full h-full object-cover rounded" data-alt="Macro detail shot of a premium lace base for a hair prosthesis, showing the fine mesh and natural knotting." src="https://lh3.googleusercontent.com/aida-public/AB6AXuCedjH6k7Lq8ZTuKCj_4m5PJlLmRR3H_qVR5JhSBoDj1pFHu5qZV1huzR350-wLAw9yFO9rt7WxeoR61Cmo59TGc8WjFVZHGWNuxuvE1ST7LjMLwtCvSa_9JGJss3-o8s92D6cPW88WgEbrVFnf4csQe-dF-RuT2HTD4EHin3d392qNqIszotN-8xGEW76LsFYJpOBoaRk_HXbuOXA-NjobicnVVKpOqhlD24Ri_Ano76Bxg6KHL3sFPg"/>
                </button>
                <button class="aspect-square rounded-lg overflow-hidden border border-outline-variant p-1 bg-surface-container-lowest hover:border-secondary transition-colors">
                    <img class="w-full h-full object-cover rounded" data-alt="A collection of professional hair system supplies including Walker tape, solvent, and adhesive." src="https://lh3.googleusercontent.com/aida-public/AB6AXuCNucS8XrRMXeofS0OJh3gbtn-Qhy-Xw2A0FmF1weqRkph90bwd6NRnkcLZNjYiRoYOeduLTIPjhLPkDL3TGkOiVPvnb0yajF-gRx8Du7oKSQd76GnxZ5VQv1qa-ldgUNNq3roDEA0rbJSaSajAhk-BFyNrQ6B2s5q3-T7UbNa68L7oc5EpDVQf1lwteyM2bc2G5hMyInKY5qql8PXrAYM6_honAB_eYX1Vft_9nVEUT-5jA34P2r0w2w"/>
                </button>
                <button class="aspect-square rounded-lg overflow-hidden border border-outline-variant p-1 bg-surface-container-lowest hover:border-secondary transition-colors">
                    <img class="w-full h-full object-cover rounded" data-alt="An open box showing the complete starter kit contents: a folded hair unit, adhesive tools, and a printed guide." src="https://lh3.googleusercontent.com/aida-public/AB6AXuA_0Y-PnqgtBo99HMfpvVChLeaUjZtbSc1OxnguGSk0OF9fvnRddjKfq1DUJVp_RkXbs1iz10cT0lHU17yJBk9nhGaE2NvXR7B2bYyhvdNffmMU8aT536YFuuXoP1CMGcm1Udarg3ybRdCOIw5ftkI5ckxOI6KyuZ0y2NxJFEtEPloCSTnCu-vXPW8be-3_FVGJP73IF1mJrtPQ-XN91ckjac-4xuDAUNS8CyY_Axwbe_0__jrblt1eMg"/>
                </button>
            </div>
        </div>
        <!-- Content Right -->
        <div class="flex flex-col gap-6">
            ...
            <div class="space-y-4 pt-4 border-t border-outline-variant">
                <div class="flex gap-4">
                    ...
                    <button class="flex-1 bg-secondary text-on-secondary font-headline-md text-headline-md py-4 rounded-xl hover:opacity-90 transition-all flex items-center justify-center gap-2">
                        Comprar Ahora
...
<footer class="bg-surface-container-highest border-t border-outline-variant mt-24">
    <div class="grid grid-cols-1 md:grid-cols-4 gap-gutter px-margin-mobile md:px-margin-desktop py-12 max-w-container-max mx-auto">
        ...
        <div class="flex flex-col gap-4">
            ...
            <div class="flex gap-4">
                <span class="material-symbols-outlined text-on-surface-variant cursor-pointer hover:text-secondary" data-icon="share">share</span>
                <span class="material-symbols-outlined text-on-surface-variant cursor-pointer hover:text-secondary" data-icon="photo_camera">photo_camera</span>
            </div>
        </div>
    </div>
